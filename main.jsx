...
import { CalendarDays, Mail, MessageCircle, Globe2, Building2, FileText, Home, ShieldCheck, Scale, BriefcaseBusiness, Landmark, ArrowRight } from 'lucide-react'
import './styles.css'
    ...
    <div className="site">
      ...
      <header className="hero">
        ...
        <nav className="nav">
          <a href="#top" className="brand">
            <img src={logoUrl} alt="Afrilink Legal Consultants Logo" />
            <div><strong>AFRILINK</strong><span>Legal Consultants</span></div>
          </a>
        ...
        <section id="top" className="heroInner">
          <div className="heroText">
            ...
            <div className="actions">
              <a href={calendlyLink} target="_blank" rel="noreferrer" className="btn primary"><CalendarDays size={18} /> Book Consultation</a>
              <a href="#practice" className="btn secondary">Explore Practice Areas <ArrowRight size={18} /></a>
            </div>
          </div>
          <div className="heroCard">
            <Landmark size={56} />
            <h2>A Boutique International Legal Consultancy</h2>
            <p>Built at the intersection of Kenyan legal expertise, international business realities, diaspora needs, and modern commercial advisory.</p>
            <div className="miniCards">
              <div>Commercial & transactional support</div>
              <div>Conveyancing and property coordination</div>
              <div>Diaspora and cross-border legal services</div>
            </div>
          </div>
        </section>
      </header>
      ...
      <section id="practice" className="section">
        <div className="sectionHead">
          ...
          <h2>Structured legal support for local and international clients</h2>
          <p>Our work is organised into clear service categories so clients can identify the support they need quickly while still understanding the legal and commercial context behind each area.</p>
        </div>
        <div className="practiceList">
          {practiceAreas.map((area, index) => (
            <article key={area.title} className="practiceCard">
              ...
              <div className="practiceDetails">
                <h4>Services under this area</h4>
                <div className="serviceGrid">
                  {area.services.map((service) => <div key={service} className="serviceItem">{service}</div>)}
                </div>
                <div className="framework">
                  <h5>Legal framework and regulatory context</h5>
                  <p>{area.framework}</p>
                </div>
              </div>
            </article>
      ...
      <section id="approach" className="approach">
        <div><p className="eyebrow">Our Approach</p><h2>Legal insight with commercial awareness</h2></div>
        <div>
          <p>Afrilink Legal Consultants is designed for clients who need more than generic legal information. Our approach combines legal analysis, practical coordination, commercial understanding, and clear communication.</p>
          <p>Whether the matter is local, diaspora-related, commercial, property-based, or cross-border, the goal is to help clients make informed decisions, manage risk, and move forward with confidence.</p>
        </div>
      </section>

      <section className="cta">
        <h2>Need legal or commercial support?</h2>
        <p>Book a consultation to discuss the nature of your matter and the type of support required.</p>
        <a href={calendlyLink} target="_blank" rel="noreferrer" className="btn dark"><CalendarDays size={18} /> Book Consultation</a>
      </section>
      ...
      <section id="contact" className="contact">
        <div>
          ...
          <p>Contact Afrilink Legal Consultants for professional legal and commercial support involving Kenya, local transactions, diaspora matters, or cross-border operations.</p>
          <div className="contactBoxes">
            <a href={`mailto:${email}`}><Mail size={20} /> {email}</a>
            <a href={calendlyLink} target="_blank" rel="noreferrer"><CalendarDays size={20} /> Book a consultation</a>
        ...
        <form className="form" action={`https://formsubmit.co/${email}`} method="POST">
          ...
          <label>Message<textarea name="message" rows="6" required placeholder="Tell us about your inquiry"></textarea></label>
      ...
      <footer>
        ...
        <p>Modern legal and commercial solutions across borders.</p>
      </footer>
    </div>
  )
}
